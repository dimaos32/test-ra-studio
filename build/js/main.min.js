...
var initSeriesSlider = function initSeriesSlider() {
  ...
  sliders.forEach(function (slider) {
    ...
    totalPages.textContent = Math.ceil(swiper.slides.length / 3) < 10 ? '0' + Math.ceil(swiper.slides.length / 3) : Math.ceil(swiper.slides.length / 3);
    swiper.on('slideChange', function () {
      var newCurrentSlide = Math.ceil(swiper.realIndex / 3 + 1) < 10 ? '0' + Math.ceil(swiper.realIndex / 3 + 1) : Math.ceil(swiper.realIndex / 3 + 1);
